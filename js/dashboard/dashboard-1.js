	...
	var chartBar = function(){
		...
		var options = { /* Alterar Dados Do Grafico de Tubo 1 */
			  series: [
				{
					name: 'Hoje',
					data: [1545270.66, 341853.91, 305747.80, 237529.59], // M28, M29, M13, M32
					//radius: 12,	
				}, 
				{
				  name: 'Ontem',
				  data: [1261106.67, 304638.84, 279466.66, 131126.76]
				}, 
	...
	var chartBar2 = function(){ /* Alterar Dados Do Grafico de Tubo 2 */
		...
		var options = {
			  series: [
				{
					name: 'Hoje',
					data: [80, 43, 333, 55, 0, 39], //Trocar Dados M13, M26, M28, M29, M30, M32
					//radius: 12,	
				}, 
				{
				  name: 'Ontem',
